...
test('unknown manifest versions cannot select files or inherited object properties', () => {
  for (const version of ['0.3.49', '../0.3.46', 'constructor', '__proto__', { toString: () => '0.3.46' }]) {
...
for (const overrides of [
  ...
  { WINDOWS_RELEASE_VERSION: '0.3.49' },
  { WINDOWS_RELEASE_VERSION: ' 0.3.46 ' },
]) {
...
for (const [requested, manifest] of [['0.3.47', MANIFEST], ['0.3.46', MANIFEST_047], ['0.3.48', MANIFEST_047], ['0.3.47', MANIFEST_048]]) {
...
for (const [manifest, newerVersion] of [[MANIFEST, '0.3.47'], [MANIFEST_047, '0.3.48'], [MANIFEST_048, '0.3.49']]) {
